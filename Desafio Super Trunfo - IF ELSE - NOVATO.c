...
int main() {
    ...
    printf("Densidade Populacional da sua primeira cidade: %.2f\n", densidadepopulacional);
    printf("PIB per capita da sua primeira cidade: %.2f\n", pibpercapita);
    printf("Super Poder desta carta: %.4f\n\n", superpoder1);
    ...
    printf("PIB em Bilhoes de R$: %.2f\n", pib2);
    printf("Quantidade de pontos turisticos: %d\n", pontosTuristicos2);
    printf("Densidade Populacional da sua segunda cidade: %.2f\n",densidadepopulacional2);
    printf("PIB per capita da sua segunda cidade: %.2f\n", pibpercapita2);
    printf("Super Poder desta carta: %.4f\n\n", superpoder2);

    printf("Agora, baseado nos dados inseridos nas duas cartas, vamos ver qual carta venceu: \n");
    printf("Digite 1 e ENTER para prosseguirmos: \n");
    scanf("%d", &resposta);

    if (resposta == 1) {
        printf("Certo, podemos prosseguir. \n");
    ...
    if (area > area2) {
    printf("A cidade %s é maior em extensão que a cidade %s. \n", nomecidade, nomecidade2);
